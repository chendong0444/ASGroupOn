...
<%@ Register Src="~/UserControls/Order_Partner.ascx" TagName="Order_Partner" TagPrefix="uc4" %>
...
<script runat="server">
    ...
    private void InitPage()
    {
        ...
        sql = "Partner_id=" + CookieUtils.GetCookieValue("partner", key) + " and service='cashondelivery' and (state='nocod' or state='pay') and Express='Y' and Express_id>0 and isnull(express_xx,'')<>'已打印'" + sql;
        ...
        if (ilistorder.Count > 0)
        {
            ...
            foreach (IOrder orinfo in ilistorder)
            {
                ...
                stContent.Append("&nbsp;|&nbsp;<a class='ajaxlink' href='" + PageValue.WebRoot + "manage/ajax_partner.aspx?action=orderview&id=" + orinfo.Id + "'>详情</a></td>");
                stContent.Append("</tr>");
                i++;
            }
