...
//      var pngwidth= $(self).width();
//           alert(pngwidth);
//           if(pngwidth>640)
//           {
//            $(self).attr("width", $(self).attr("w"));
//           }

             
             //  $(self).toggleClass("dynload");
...
(function($){
    imageSlidePlayer = function(object,config){
        ...
        var _this = this;
        var t;
        var defaults = {fontsize:12,right:10,bottom:3,time:5000,autosize:0};
        ...
        this.factory = function(){
            ...
            if($titles.size() > 0) {
                ...
                $(this.obj + " .dkTitleBg").css({position:"absolute",margin:"0",padding:"0",zIndex:"1",bottom:"0",left:"0",width:"100%",height:_this.height+"px",background:"#000",opacity:"0.4",overflow:"hidden"})
                //插入标题
        ...
        this.resetclass =function(obj,i){
            $(obj).css({'float':"left",marginRight:"3px",width:"14px",height:"18px",lineHeight:"18px",textAlign:"center",fontWeight:"800",fontSize:"12px",color:"#fff",background:"rgb(51,51,51)",cursor:"pointer",border:"1px solid #BFBFBF",fontFamily:"宋体"});
            $(obj).eq(i).css({color:"#FFF",background:"rgb(161,0,0)",textDecoration:"none"});
        }
        this.factory();
    }
})(jQuery);
