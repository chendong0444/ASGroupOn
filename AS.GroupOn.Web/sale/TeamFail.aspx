...
<script runat="server">
    ...
    private void getDangqian()
    {
        ...
        pagerhtml = WebUtils.GetPagerHtml(30, pager.TotalRecords, pager.CurrentPage, PageValue.WebRoot + "sale/TeamFail.aspx?" + url + "&page={0}");
                                ...
                                <div class="head">
                                    ...
                                    <div class="search">
                                        ...
                                        <ul class="filter" style="top: 0">
                                            <li class="<%=style %>" style="padding-top: 11px;"><a href="TeamFail.aspx">全部</a></li>
                                            <li class="<%=style1 %>" style="padding-top: 11px;"><a href="TeamFail.aspx?team_type=normal">
                                                团购</a></li>
                                            <li class="<%=style2 %>" style="padding-top: 11px;"><a href="TeamFail.aspx?team_type=seconds">
                                                秒杀</a></li>
                                            <li class="<%=style3 %>" style="padding-top: 11px;"><a href="TeamFail.aspx?team_type=goods">
                                                热销</a></li>
                                        </ul>
                                    </div>
                                </div>
