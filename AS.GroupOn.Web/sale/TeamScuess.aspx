...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (Request.QueryString["team_type"] != null)
        {
            ...
            sqlWhere = "sale_id=" + strSaleId + " and End_time <GetDate() and  Now_number>=Min_number  and Team_type='" + request_teamtype.Replace("'", "''") + "'  ";
        ...
        {
            sqlWhere = "sale_id=" + strSaleId + " and End_time <GetDate() and Now_number>=Min_number and  Team_type<>'point' ";
        }
    ...
    public string sqlWhere
    {
        get
        {
            if (this.ViewState["sqlWhere"] != null)
                ...
                return " sale_id=" + strSaleId + " and End_time <GetDate() and Now_number>=Min_number and  Team_type<>'point' ";
    ...
    private void getDangqian()
    {
        ...
        pagerhtml = WebUtils.GetPagerHtml(30, pager.TotalRecords, pager.CurrentPage, PageValue.WebRoot + "sale/TeamScuess.aspx?" + url + "&page={0}");
                                ...
                                <div class="head">
                                    ...
                                    <div class="search">
                                        ...
                                        <ul class="filter" style="top: 0">
                                            <li class="<%=style %>" style="padding-top: 11px;"><a href="TeamScuess.aspx">全部</a></li>
                                            <li class="<%=style1 %>" style="padding-top: 11px;"><a href="TeamScuess.aspx?team_type=normal">
                                                团购</a></li>
                                            <li class="<%=style2 %>" style="padding-top: 11px;"><a href="TeamScuess.aspx?team_type=seconds">
                                                秒杀</a></li>
                                            <li class="<%=style3 %>" style="padding-top: 11px;"><a href="TeamScuess.aspx?team_type=goods">
                                                热销</a></li>
                                        </ul>
                                    </div>
                                </div>
