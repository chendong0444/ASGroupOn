                        ...
                        <div class="box clear">
                            <div class="box-content">
                                ...
                                <div class="search">
                                    ...
                                    <%} %>
                                    &nbsp;&nbsp; 生成订单时间：<input type="text" class="h-input" datatype="date" style=" margin-right:0px;" name="begintime"
                                        ...
                                        <%} %> />--<input type="text" class="h-input" datatype="date" name="endtime" <%if(!string.IsNullOrEmpty(Request.QueryString["endtime"])){ %>value="<%=Request.QueryString["endtime"] %>"
                                            <%} %> />&nbsp;&nbsp; 完成订单时间：<input type="text" class="h-input" style=" margin-right:0px;" datatype="date" name="fromfinishtime" style=" margin-right:0px;"
