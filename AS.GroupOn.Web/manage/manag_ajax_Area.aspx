<%@ Page Language="C#" AutoEventWireup="true" Debug="true"  EnableViewStateMac ="false" EnableSessionState="True" EnableEventValidation ="false" ValidateRequest ="false" ViewStateEncryptionMode ="Never"  Inherits="AS.GroupOn.Controls.AdminPage" %>
...
<div id="order-pay-dialog" class="order-pay-dialog-c" style="width: 380px;">
    <h3>
        ...
        <%if (upid != null && upid!="")
          {%>
              <span id="bian" style=" float:left; text-indent:5px;" runat="server">编辑</span>
          <%}
          else
          { %>
              <span id="xin" style=" float:left; text-indent:5px;" runat="server">新建</span>
         <% }
              %>
        <span id="mingcheng"
                runat="server"></span></h3>
    <div style="overflow-x: hidden; padding: 10px;"  runat="server">
        <p>
            中文名称：均要求分类唯一性</p>
        <input type="hidden" runat="server" id="hid" ></input>
          <input type="hidden" runat="server" id="uphid"></input>
        <table width="96%" class="coupons-table-xq" runat="server">
            <tr>
                <td width="80" nowrap>
                    <b>中文名称：</b>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="submit" name="button" group="city" class="formbutton" action="manag_ajax_Area.aspx"
                        value="确定" />
                </td>
            </tr>
        </table>
