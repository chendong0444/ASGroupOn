...
namespace AS.Common.Utils
{
    ...
    public class OAuth
    {
        ...
        public bool GetRequestToken(string callback)
        {
            ...
            return this.GetRequestToken("http://openapi.qzone.qq.com/oauth/qzoneoauth_request_token", callback);
        }
        /// <summary>
        ...
        /// <summary>
        /// 使用默认的API地址同步获取授权的Access Token，调用此方法时必须设置与TokenTokenSecret属性的值为request_token与request_secret
        ...
        public bool GetAccessToken(string verifier, out string name)
        {
            ...
            return this.GetAccessToken("http://openapi.qzone.qq.com/oauth/qzoneoauth_access_token", verifier, out name);
        }
        /// <summary>---使用完毕
        ...
        public bool GetAccessToken(string requestUrl, string verifier, out string name)
        {
            ...
            parameters.Add("oauth_vericode", verifier);
            var r = this.GetOAuthToken(requestUrl, parameters, out responseData);
            name = responseData == null ? null : responseData["openid"];
            return r;
        }
