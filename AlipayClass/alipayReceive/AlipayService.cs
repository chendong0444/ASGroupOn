...
namespace AlipayClass.alipayReceive
{
    ...
    public class Service
    {
        ...
        public string User_logistics_address_query(string token)
        {
            //临时请求参数数组
            SortedDictionary<string, string> sParaTemp = new SortedDictionary<string, string>();
            //确认按钮显示文字
            string strButtonValue = "使用支付宝收货地址";
            //表单提交HTML数据
            string strHtml = "";
        ...
        /// <param name="token">授权令牌</param>
        /// <returns>表单提交HTML信息</returns>
        public string User_logistics_address_queryURL(string token)
        {
            //临时请求参数数组
            SortedDictionary<string, string> sParaTemp = new SortedDictionary<string, string>();
            //确认按钮显示文字
            ...
            //构造表单提交HTML数据
            strHtml = Submit.BuildFormHtmlURL(sParaTemp, GATEWAY_NEW, "get", strButtonValue);
